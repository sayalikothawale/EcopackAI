...
class Recommendation(db.Model):
    ...
    strength = db.Column(db.Float)   # ✅ Added strength
...
def home():
    ...
    if request.method == "POST":
        ...
        # Fragility factor for strength requirement
        ...
        for _, row in df.iterrows():
            ...
            # FINAL SCORE (NOW INCLUDES STRENGTH)
        ...
        if results:
            ...
            new_entry = Recommendation(
                ...
                strength=float(best["Strength"]),   # ✅ Saved
